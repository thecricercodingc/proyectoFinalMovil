...
class BaseDatos {
    ...
    companion object{
        ...
        var historiaClinica = HistoriaClinicaModel(1,visitas, medicamentos, condicionRespiratoriaModel(209.2F,"No tiene problemas"))
        var vacunas = mutableListOf(Vacuna(1,"Albendazol", 7F, "12-12-2022"),Vacuna(1,"Metronidazol", 7F, "12-12-2022") )

        var mascotas = mutableListOf(Pet(1,"Carlota", "12-05-2020", 3,"papilón", "mascotaej", "calmada", 4.5F, historiaClinica, vacunas))
